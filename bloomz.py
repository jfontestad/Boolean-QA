...
from transformers import get_scheduler, AutoTokenizer, AutoModelForSequenceClassification, AutoModelForCausalLM
...
def pre_process(model_name, batch_size, device, small_subset=False):
    ...
    mytokenizer = AutoTokenizer.from_pretrained("bigscience/bloomz")
    ...
    # pretrained_model = AutoModelForCausalLM.from_pretrained("bigscience/bloomz")
    pretrained_model = AutoModelForSequenceClassification.from_pretrained("bigscience/bloomz")
